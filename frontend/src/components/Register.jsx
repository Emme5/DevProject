...
const Register = () => {
  ...
  return (
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
      ...
      px-8 pt-6 pb-8 mb-4'>
        <h2 className='text-xl font-extrabold mb-4 flex justify-center'>กรุณาลงทะเบียน</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            text-white font-bold py-2 px-8 rounded focus:outline-none'>ลงทะเบียน</button>
          </div>
        </form>
        <p className='align-baseline font-medium mt-4 text-sm'>หากมีบัญชีโปรด
          <Link to="/login" className='text-blue-500 hover:text-blue-700'> ลงชื่อเข้าใช้ได้เลย</Link>
        </p>
        ...
        <p className='mt-5 text-center text-gray-500 text-sm'>© 2023 Copyright : ร้านขายหนังสือ</p>
      </div>
    </div>
  )
}
