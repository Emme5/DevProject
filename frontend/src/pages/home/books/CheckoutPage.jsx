  ...
  return (
    ...
    <div className="container max-w-screen-lg mx-auto">
        <div>
            ...
            <p className="text-gray-500 mb-6">จำนวนสินค้า : {cartItem.length > 0 ?
            cartItem.length : 0}</p>
            </div>
            ...
            <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                    <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
                        <div className="text-gray-600">
                            <p className="font-medium text-3xl">รายละเอียดส่วนตัว</p>
                            <p className='text-base'>กรุณากรอกข้อมูลให้ครบถ้วน.</p>
                        </div>
                        ...
                        <div className="lg:col-span-2">
                            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                ...
                                <div className="md:col-span-5">
                                    <label html="phone">เบอร์โทรศัพท์</label>
                                    <input
                                ...
                                <div className="md:col-span-3">
                                    <label htmlFor="address">ที่อยู่ / ถนน</label>
                                    <input
                                ...
                                <div className="md:col-span-2">
                                    <label htmlFor="country">ประเทศ / ภูมิภาค</label>
                                ...
                                <div className="md:col-span-2">
                                    <label htmlFor="state">รัฐ / จังหวัด</label>
                                    <div className="h-10 bg-gray-50 flex border border-gray-200 rounded items-center mt-1">
                                        <input 
                                ...
                                <div className="md:col-span-5 mt-3">
                                    <div className="inline-flex items-center">
                                        ...
                                        type="checkbox" name="billing_same"
                                        id="billing_same" className="form-checkbox" />
                                        <label htmlFor="agree" className="ml-2 ">ฉันยอมรับ <Link className='underline underline-offset-2 text-blue-600'>ข้อกำหนด & เงื่อนไข</Link>
                                        และ <Link className='underline underline-offset-2 text-blue-600'>นโยบายการช้อปปิ้ง.</Link></label>
                                    </div>
                                </div>
                                ...
                                <div className="md:col-span-5 text-right">
                                    <div className="inline-flex items-end">
                                        <button 
                                        disabled={!isChecked}
                                        className="bg-blue-500 hover:bg-blue-700 text-white font-normal py-2 px-4 rounded">สั่งซื้อสินค้า</button>
                                    </div>
                                </div>
