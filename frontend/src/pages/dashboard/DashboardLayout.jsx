  ...
  return (
    ...
    <aside className="hidden sm:flex sm:flex-col">
      <a href="/" className="inline-flex items-center justify-center h-20 w-20">
        <img src="/IT_Samutsk_logo.png" alt="" />
      </a>
      <div className="flex-grow flex flex-col justify-between text-gray-200 bg-gray-800">
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
            ...
            <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
              <span className="font-semibold">Mongkol Suphamanee</span>
              <span className="text-sm text-gray-600">A student</span>
            </div>
            <span className="h-12 w-12 ml-2 sm:ml-3 mr-2 bg-gray-100 rounded-full overflow-hidden">
              <img src="https://i.natgeofe.com/n/4f5aaece-3300-41a4-b2a8-ed2708a0a27c/domestic-dog_thumb_square.jpg" alt="user profile photo" className="h-full w-full object-cover"/>
            </span>
