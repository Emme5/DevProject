      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">จำนวนหนังสือ</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">ยอดขายรวม</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">หนังสือที่กำลังได้รับความนิยมในเดือนนี้</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">ยอดสั่งซื้อรวม</span>
                </div>
              </div>
            </section>
                  ...
                  <ul className="p-6 space-y-6">
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://cdn-icons-png.flaticon.com/512/10337/10337609.png" alt="Annette Watson profile picture"/>
                      </div>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://cdn-icons-png.flaticon.com/512/10337/10337609.png" alt="Calvin Steward profile picture"/>
                      </div>
                      <span className="text-gray-600">Firstname Lastname</span>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://cdn-icons-png.flaticon.com/512/10337/10337609.png" alt="Ralph Richards profile picture"/>
                      </div>
                      <span className="text-gray-600">Firstname Lastname</span>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://cdn-icons-png.flaticon.com/512/10337/10337609.png" alt="Bernard Murphy profile picture"/>
                      </div>
                      <span className="text-gray-600">Firstname Lastname</span>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://cdn-icons-png.flaticon.com/512/10337/10337609.png" alt="Arlene Robertson profile picture"/>
                      </div>
                      <span className="text-gray-600">Firstname Lastname</span>
                      <span className="ml-auto font-semibold">8.2</span>
                    </li>
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://cdn-icons-png.flaticon.com/512/10337/10337609.png" alt="Jane Lane profile picture"/>
                      </div>
                      <span className="text-gray-600">Firstname Lastname</span>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://cdn-icons-png.flaticon.com/512/10337/10337609.png" alt="Pat Mckinney profile picture"/>
                      </div>
                      <span className="text-gray-600">Firstname Lastname</span>
                    ...
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        <img src="https://cdn-icons-png.flaticon.com/512/10337/10337609.png" alt="Norman Walters profile picture"/>
                      </div>
                      <span className="text-gray-600">Firstname Lastname</span>
